...
//    }
    ...
    public List<RosterPlayer> createRosterPlayers() {
    	...
    	Team teamLAL = Team.findByAbbr("LAL", ProcessingType.online);
  	  	...
  	  	RosterPlayer rosterPlayer1 = TestMockHelper.getRosterPlayer(player1, teamGS, "2014-03-01", "2014-06-30"); 
  	  	RosterPlayer.create(rosterPlayer1, ProcessingType.online);
  	  	rosterPlayers.add(rosterPlayer1);
  	  	
  	  	RosterPlayer rosterPlayer2 = TestMockHelper.getRosterPlayer(player1, teamSAC, "2014-02-01", "2014-02-28"); 
  	  	RosterPlayer.create(rosterPlayer2, ProcessingType.online);
  	  	rosterPlayers.add(rosterPlayer2);
  	  	
  	  	RosterPlayer rosterPlayer3 = TestMockHelper.getRosterPlayer(player1, teamGS, "2014-01-01", "2014-01-31"); 
  	  	...
  	  	RosterPlayer rosterPlayer4 = TestMockHelper.getRosterPlayer(player2, teamSAC, "2014-04-01", "2014-04-30"); 
  	  	RosterPlayer.create(rosterPlayer4, ProcessingType.online);
  	  	rosterPlayers.add(rosterPlayer4);
  	  	
  	  	RosterPlayer rosterPlayer5 = TestMockHelper.getRosterPlayer(player2, teamLAL, "2013-11-01", "2014-02-28"); 
  	  	RosterPlayer.create(rosterPlayer5, ProcessingType.online);
  	  	rosterPlayers.add(rosterPlayer5);
  	  	
  	  	RosterPlayer rosterPlayer6 = TestMockHelper.getRosterPlayer(player2, teamSAC, "2012-10-30", "2013-06-30"); 
